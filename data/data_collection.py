...
scripts = {
    ...
    'Greek': range(0x0386,0x0386+1) + range(0x0388,0x038A+1) + range(0x038C,0x038C+1) + range(0x038E,0x03A1+1)
             + range(0x03A3,0x03CE+1),
    ...
    'Tamil': range(0x0B85,0x0B8A+1) + range(0x0B8E, 0x0B90+1) + range(0x0B92, 0x0B95+1)
            + range(0x0B99, 0x0B9A+1)+ range(0x0B9C, 0x0B9C+1)+ range(0x0B9E, 0x0B9F+1)
            + range(0x0BA3, 0x0BA4+1) + range(0x0BA8, 0x0BAA+1) + range(0x0BAE, 0x0BB9+1),
    'Malayalam': range(0x0D05,0x0D0C+1) + range(0x0D0E, 0x0D10+1) + range(0x0D12, 0x0D28+1) + range(0x0D2A, 0x0D39+1),
